...
/*
 * Этот класс - швейцарский нож, тут сложена различная хуита, которую к другим классам отнести неудобно.
 * Он умеет делать из строк байты, из байтов хексы, из хексов - шестнадцатиричные пирожки с массивами.
 */
